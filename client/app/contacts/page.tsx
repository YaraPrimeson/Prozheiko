...
import style from "@/app/about-doctors/doctors.module.scss";
  ...
  return (
    <>
      ...
      <div className={globalStyles.wrapper}>
        <section className={style.contacts__container}>
          <Image
          ...
          />
          <div>
            <h3 className={style.contacts__title}>СТОМАТОЛОГІЧНА КЛІНІКА</h3>
            ...
            <div className={style.social__links__wrapper}>
              ...
              <a href="@/src/app/contacts/page#" className={style.social__link}>
                <svg
                  width="16"
                  height="16"
                  viewBox="0 0 16 16"
