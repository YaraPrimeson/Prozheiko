        ...
        <footer className={style.footer}>
            <div className={style.info__container}>
                <div className={style.logo__container}>
                    <Image className={style.logo__img} src={logo} alt="My Image" width={250} height={50}
                           loading="lazy"/>
                    <p className={style.logo__subtitle}>Місце здорових посмішок</p>
                    <a className={style.logo__phone} href="tel:+38 (073) 38-38-532">+38 (073) 38-38-532</a>
                </div>
                <div className={style.general}>
                    ...
                    <ul className={style.general__list__container}>
                        <li className={style.general__list}>
                            <Link className={`${style.general__link} ${style.footer__text}`} href="#">Консультація
                                стоматолога</Link>
                        </li>
                        <li className={style.general__list}>
                            <Link className={`${style.general__link} ${style.footer__text}`} href="#">Лазерне
                                відбілювання</Link>
                        </li>
                        <li className={style.general__list}>
                            <Link className={`${style.general__link} ${style.footer__text}`} href="#">Лікування
                                карієсу</Link>
                        </li>
                        <li className={style.general__list}>
                            <Link className={`${style.general__link} ${style.footer__text}`} href="#">Ціни</Link>
                        </li>
                        <li className={style.general__list}>
                            <Link className={`${style.general__link} ${style.footer__text}`} href="#">Про клініку</Link>
                        </li>
                    </ul>
                </div>
                <div className={style.schedule}>
                    ...
                    <div className={style.schedule__wrapper}>
                        <div className={style.schedule__container}>
                            ...
                            <p className={style.footer__text}>Субота</p>
                ...
                <div className={style.contacts__container}>
                    ...
                    <div className={style.contact__link__container}>
                        ...
                        <a className={style.contact__link} href="mailto:clients@prozheiko.kiev.ua">
                            <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                ...
                                <path
                                    ...
                                    stroke="white" strokeLinecap="round" strokeLinejoin="round"/>
                                <path d="M20.1667 5.5L11 11.9167L1.83334 5.5" stroke="white" strokeLinecap="round"
                                      strokeLinejoin="round"/>
                            </svg>
                            clients@prozheiko.kiev.ua
                        </a>
                        <a className={style.contact__link} href="https://goo.gl/maps/GuDTGWF4MJrS3UA8A" target="_blank">
            ...
            <div className={style.social__container}>
                <div className={style.social__text__wrapper}>
                    <p className={style.social__text}>Усі права захищено © Стоматологічна клініка PROZHEIKO DENTAL
                        STUDIO</p>
                </div>
                <div className={style.social__links__wrapper}>
                    <a href="#" className={`${style.social__link} ${style.facebook}`}>
                    ...
                    <a href="#" className={style.social__link}>
                        <svg width="15" height="10" viewBox="0 0 15 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                                ...
                                fill="white"/>
                            <path d="M5.71753 7.14075L9.43518 4.99957L5.71753 2.8584V7.14075Z" fill="black"/>
                        </svg>
