    ...
    switch (type) {
      case "like": {
        if (evaluation === "dislike") {
          ...
          return fetchEvaluation(likeCount.toString(), dislikeState);
        }
        localStorage.setItem(id, "like");
        likeCount = Number(likeState) + 1;
        return fetchEvaluation(likeCount.toString(), dislikeState);
        ...
        if (evaluation === "dislike") {
          dislikeCount =
            Number(dislikeState) >= 1
              ...
              : Number(dislikeState);
          localStorage.removeItem(id);
          return fetchEvaluation(likeState, dislikeCount.toString());
        } else if (evaluation === "like") {
      ...
      <div className={style.evaluation__icons__container}>
        <div className={style.icon__container}>
          <svg
            ...
            className={`${style.icon} ${
              evaluation === "like" && `${style.animate}`
            }`}
            viewBox="0 0 53 54"
            fill={localStorage.getItem(id) === "like" ? "#12979B" : "none"}
          ...
          >
            <path
              ...
              stroke={localStorage.getItem(id) === "like" ? "none" : "#79797A"}
              strokeWidth="3"
              strokeMiterlimit="10"
            />
            <path
        ...
        <div className={style.icon__container}>
          <svg
            ...
            className={`${style.icon} ${
              evaluation === "dislike" && `${style.animate}`
            }`}
            viewBox="0 0 54 54"
            fill={localStorage.getItem(id) === "dislike" ? "#12979B" : "none"}
            xmlns="http://www.w3.org/2000/svg"
          >
            <path
              ...
              stroke={
                localStorage.getItem(id) === "dislike" ? "none" : "#79797A"
              }
              strokeWidth="3"
              strokeMiterlimit="10"
            />
