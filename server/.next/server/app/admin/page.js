...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 54312)), "/Users/yariksemenov/Desktop/prozheiko/client/app/admin/page.tsx"],
    ...
    const pages = ["/Users/yariksemenov/Desktop/prozheiko/client/app/admin/page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 68584))
...
//   type: "text" | "image" | "lineBreak" | "title";
//   value: string | File;
// }
const Page = ()=>{
    const [blog, setBlog] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)([]);
    const [block, setBlock] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(null);
    ...
    // const handleAddText = () => {
    //   if (currentText.trim() !== "") {
    //     const newTextItem: ContentItem = {
    //       type: "text",
    //       value: currentText.trim(),
    //     };
    //     setContentItems([...contentItems, newTextItem]);
    //     setCurrentText("");
    //   }
    // };
    //
    // const handleAddLineBreak = () => {
    //   const lineBreakItem: ContentItem = {
    //     type: "lineBreak",
    //     value: "",
    //   };
    //   setContentItems([...contentItems, lineBreakItem]);
    // };
    //
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/yariksemenov/Desktop/prozheiko/client/app/admin/page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [405,357,631], () => (__webpack_exec__(84093)));
